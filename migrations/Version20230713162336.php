 ...
 */
final class Version20230713162336 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE album CHANGE is_private is_private TINYINT(1) NOT NULL, CHANGE is_main_album is_main_album TINYINT(1) NOT NULL');
    }
}
